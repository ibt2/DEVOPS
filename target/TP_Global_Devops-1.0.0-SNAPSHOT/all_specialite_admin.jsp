...
<body>
		...
		<ul class="side-menu top">
			...
			<li>
				<a href="Medecin_servlet?action=list_med">
					...
					<span class="text">Gestion des médécins</span>
				</a>
			</li>
			<li class="active">
	...
	<section id="content">
		...
		<div class="head-title">
				<div class="left">
					<h1>Voici la liste des spécialités</h1>
				</div>
				</div>
...
<td> ${spe.nom}</td>
<td>
        <a href="Spec_servlet?action=edit&id=${spe.id}" class="btn-edit">Modifier</a>
        <a href="Spec_servlet?action=delete&id=${spe.id}" class="btn-delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette spécialité ?');">Supprimer</a>
    </td>
</tr>
</c:forEach>
</tbody>
			...
			<div class="add-button">
                <a href="form_addspec.jsp" class="btn">
